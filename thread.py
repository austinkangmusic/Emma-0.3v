    ...
    while True:
        ...
        if voice_detected.lower() == 'true':
            ...
            while True:
                ...
                # Read the content of the file and store it in the voice_detected variable
                try:
                    with open('pause_detected.txt', 'r') as file:
                    ...
                    if user_input:
                        ...
                        try:
                            with open("transcription/user_input.txt", "w") as file:
                                ...
                                # print("Transcription saved to 'transcription/user_input.txt'.")
                        except Exception as e:
                            pass
...
def execute():
    ...
    file_path = 'audios/user_audio.wav'
